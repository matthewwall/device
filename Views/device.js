var device = {
    ...
    'initTemplate':function(id,dryrun)
    {
        var result = {};
        $.ajax({ url: path+"device/template/init.json", data: "id="+id+"&dryrun="+dryrun, dataType: 'json', async: false, success: function(data) {result = data;} });
        return result;
    }
}
